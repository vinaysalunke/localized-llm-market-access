...
print("Step 3: Loading Qwen 1.5B Model Locally...")
...
df.to_excel("data/golden_dataset/RAG_Optimization_Results_Local.xlsx", index=False)
print("Saved to RAG_Optimization_Results_Local.xlsx")
