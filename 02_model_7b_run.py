...
print("Step 3: Loading Qwen 7B Model Locally...")
...
df.to_excel("data/golden_dataset/Advanced_7B_RAG_Results.xlsx", index=False)
print("Saved to Advanced_7B_RAG_Results.xlsx")
